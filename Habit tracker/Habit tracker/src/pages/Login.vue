    ...
    <section class="auth-wrap">
      <div class="auth-card">
        <div class="auth-head">
          ...
          <p class="auth-subtitle">Inicia sessão para continuares o teu progresso.</p>
        </div>
        ...
        <form class="auth-form" @submit.prevent="handleLogin">
          ...
          <button class="auth-btn" type="submit" :disabled="store.loading">
            {{ store.loading ? "A entrar..." : "Entrar" }}
          </button>
          ...
          <p class="auth-foot">
            ...
            <router-link class="auth-link" :to="{ name: 'register' }">Regista-te</router-link>
          </p>
        </form>
      </div>
    </section>
